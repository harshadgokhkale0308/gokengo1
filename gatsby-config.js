module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        endpoint:
          "https://gokenamerica.us10.list-manage.com/subscribe/post?u=75d700378479b30683e02abbd&amp;id=248638bce6", // string; add your MC list endpoint here; see instructions below
