              ...
              <div className="card card_one">
                <div className="content">
                  ...
                  <div className="copy">
                    ...
                    It helps to understand what a manufacturing function has
                    done in the past and what it is doing now and, thus, it
                    provides a basis for planning what it is going to do in the
                    future.
                  </div>
                </div>
              </div>
            ...
            <div className="two">
              <div className="card card_two">
                <div className="content">
                  ...
                  <div className="copy">
                    {" "}
                    Measurements records parameters that monitor the condition
                    of an asset. It includes vibration data, acoustic data,
              ...
              <div className="card card_four">
                <div className="content">
                  ...
                  <div className="copy">
                    ...
                    asset, line by line, process by process and plant by plant
                    to capture the full value of the technology. Analytics
                    dashboard is not a one-off exercise
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="six">
              <div className="card card_six">
                <div className="content">
                  ...
                  <div className="copy">
                    Feedback is the most important part of the delegation
                    process, and it works both ways. A tool that will help you
                    complete the feedback loop can be highly effective for
                    delegation. Without delegation, quality of work diminishes
                    and increases chances of missing deadlines
                  </div>
                </div>
              </div>
            </div>
            <div className="seven">
              <div className="card card_six">
                <div className="content">
                  ...
                  <div className="copy">
                    Effective problem solving in manufacturing requires clear
                    and decisive action. Decision making can be improved by
                    systematic rational approach supported by good data
                    management
                  </div>
                </div>
              </div>
